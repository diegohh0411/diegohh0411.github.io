    ...
    insert(_el$, createComponent(For, {
      ...
      children: (ij, i) => (() => {
        ...
        createRenderEffect((_p$) => {
          var _v$ = ij.loImgH, _v$2 = ij.loImgW, _v$3 = ij.loUrl, _v$4 = ij.alt, _v$5 = `translate3d(${i() !== 0 ? getRandom(-25, 25) : 0}%, ${i() !== 0 ? getRandom(-30, 30) : 0}%, 0)`;
...
async function loadSwiper() {
  const s = await __vitePreload(() => import("./Cm9GDa.js"), true ? __vite__mapDeps([]) : void 0);
  return s.Swiper;
}
