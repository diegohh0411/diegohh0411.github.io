...
async function loadGsap() {
  const g = await __vitePreload(() => import("./D9-9GH.js"), true ? __vite__mapDeps([]) : void 0);
  return g.gsap;
}
...
function updateThreshold(currentThreshold, thresholds2, stride) {
  ...
  if (i < 0 || i >= thresholds2.length)
    return thresholds2[i - stride];
...
const Desktop = lazy(async () => await __vitePreload(() => import("./De61Tp.js"), true ? __vite__mapDeps([]) : void 0));
const Mobile = lazy(async () => await __vitePreload(() => import("./DuQXvi.js"), true ? __vite__mapDeps([]) : void 0));
function Main() {
